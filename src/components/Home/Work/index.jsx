  ...
  const renderCard = (key, index, position) => {
    ...
    return (
      <div
        ...
        className="w-full h-[550px] md:h-[550px] mt-5 sm:mt-0 relative sm:bg-transparent bg-[#F6F6F4]- !bg-white rounded-[30px] overflow-hidden"
      >
        ...
        <div
          className={`flex flex-col py-4 sm:pt-[40px] md:pt-[60px] px-2 sm:px-10 lg:px-16 sm:justify-center md:justify-normal md:items-start items-center h-1/2 sm:h-full ${
            index % 2 === 0 ? "sm:right-0" : "sm:left-0"
          } relative sm:absolute sm:top-0 w-full md:w-3/4 lg:w-2/3 xl:w-1/2 workContainer z-20`}
        >
  ...
  return (
    ...
    text-center"
      ...
      <div
        ...
        className="relative hidden md:block w-screen h-[580px] md:h-[750px] bg-[#F6F6F4]- bg-white overflow-visible"
      >
