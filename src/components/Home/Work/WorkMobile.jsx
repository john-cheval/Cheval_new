    ...
    >
      ...
      <div className="flex flex-col items-center pt-4">
        ...
        <div
          ...
          className={`w-full md:hidden h-fit pb-6 border-b group ${
            data[key]?.ID === 2590 ? "border-b-0" : "border-b"
          } cursor-pointer border-black border-dotted flex items-center justify-center`}
        >
          <DarkButton
